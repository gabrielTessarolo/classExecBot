                ...
                if ('dialog' in actTd.get_attribute('class').split() and 'letivo' in actTd.get_attribute('class').split()):
                    ...
                    if actTd.get_attribute('data-planejado')=="True":
                        ...
                        if actTd.get_attribute('data-executado')=="False":
                            print(f'Aula do dia {actDay} \033[34melegível para ser executada\033[m.')
                            executeClass(actTd)
                    else: 
                        print(f'Aula do dia {actDay} \033[31mnão planejada\033[m.')
        ...
        for col in range([3,5][idx==1], 6):
            ...
            if actDay < diaMes:
                ...
                if ('dialog' in actTd.get_attribute('class').split() and 'letivo' in actTd.get_attribute('class').split()):
                    ...
                    if actTd.get_attribute('data-executado')=="False":
                        print(f'Frequência do dia {actDay} \033[34melegível para ser executada\033[m.')
                        executeFreq(actTd)
